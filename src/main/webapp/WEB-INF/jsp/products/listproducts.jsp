...
uri="http://www.springframework.org/tags" prefix="s"%>
          ...
          ">
                                                ...
                                                <select id="select-category" onchange="onSelectCategory(event)" style="
              margin-left: 10px;
              margin-top: 3px;
              display: block;
              padding: 5px;
              ...
              <option value="${category.id}">${category.name}</option>
                                                ...
                                                <form action="/products/search">
                                                    <div class="search-box" style="width: 198px; float: right; margin: 0px 15px">
                                                        <input name="key" value="${key }" placeholder="Tìm kiếm..." style="
                  height: 38px;
                  width: 155px;
                  outline: none;
                  border: 1px solid #ff1464;
                                            ...
                                            <div class="content">
                                                <c:forEach items="${products}" var="pro">
                                                    <div class="pro-content">
                                                        <a href="/products/details?id=${pro.id}">
                                                        ...
                                                        <p style="font-weight: 700; color: #ff2435; font-size: 18px">
                                                            <fmt:formatNumber type="number" maxFractionDigits="1" value="${pro.getPrice()}" /> đ
                                                        </p>
                                                        <p>
                                                            Ngày đăng:
                ...
                ">
                                                        ...
                                                        <a class="btn-content" href="/them-vao-gio/${pro.getId()}" th:text="${[[Mua ngay]]}"></a>
                                                    </div>
                                                </c:forEach>
                                            </div>
                                        </div>
                                            ...
                                            <div class="small-container">
                                                <div class="content">
                                                    ...
                                                    <div class="text-content">
                                                        ...
                                                        <h1>Mi Band 4</h1>
                                                        <small>The Mi Band 4 features a 39.9% larger than Mi Band 3 AMOLED
                color full-touch display with adjustable brightness, so
