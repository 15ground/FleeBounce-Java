	...
	<section class="home-section">
		<nav>
			<div class="sidebar-button">
				<i class='bx bx-menu sidebarBtn'></i> <span class="dashboard">Trang
					chủ</span>
			</div>
		...
		<div class="home-content">
			<div class="overview-boxes">
				<div class="box">
					<div class="right-side">
						...
						<div class="indicator">
							<i class='bx bx-up-arrow-alt'></i> <span class="text">Tăng
								so với ngày vừa qua</span>
						</div>
					</div>
				...
				<div class="box">
					<div class="right-side">
						<div class="box-topic">Tổng đơn hàng trả lại</div>
						<div class="number">11,086</div>
						<div class="indicator">
							<i class='bx bx-down-arrow-alt down'></i> <span class="text">Giảm
								so với ngày vừa qua</span>
						</div>
					</div>
			...
			<div class="sales-boxes">
				<div class="recent-sales box">
					<div class="title">Doanh thu gần đây</div>
